...
This repo contains the code for HyperClipboard, a simple Bad Echo utility that allows the user to paste multiple items from their clipboard history at a time.
